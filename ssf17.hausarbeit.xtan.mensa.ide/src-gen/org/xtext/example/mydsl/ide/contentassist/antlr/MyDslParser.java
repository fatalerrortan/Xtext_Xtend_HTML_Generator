		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMensamodelAccess().getFooterAssignment_1(), "rule__Mensamodel__FooterAssignment_1");
					put(grammarAccess.getMensamodelAccess().getSiderbarAssignment_2(), "rule__Mensamodel__SiderbarAssignment_2");
					...
					put(grammarAccess.getSiderbarAccess().getButtonAssignment_5(), "rule__Siderbar__ButtonAssignment_5");
