 ...
 */
package ssf17.hausarbeit.xtan.mensa.ui.internal;
 ...
 * introduced subclass. 
 */
public class MensaActivator extends AbstractUIPlugin {

	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(MensaActivator.class);
	
	private static MensaActivator INSTANCE;
	...
	public static MensaActivator getInstance() {
		return INSTANCE;
	}
